...
export type PastLaunchesListQuery = (
  ...
  & { launchesPast: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'launch_success' | 'mission_name' | 'launch_date_utc'>
    & { launch_site: Maybe<(
      { __typename?: 'LaunchSite' }
      & Pick<LaunchSite, 'site_id' | 'site_name'>
    )>, rocket: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export type LaunchItemDetailsQueryVariables = {
  id: Scalars['ID']
};


export type LaunchItemDetailsQuery = (
  { __typename?: 'Query' }
  & { launch: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'details' | 'launch_date_utc' | 'launch_success' | 'mission_name'>
    & { launch_site: Maybe<(
      { __typename?: 'LaunchSite' }
      & Pick<LaunchSite, 'site_id' | 'site_name'>
    )>, links: Maybe<(
...
export const LaunchItemDetailsDocument = gql`
    query launchItemDetails($id: ID!) {
  launch(id: $id) {
    id
    details
    launch_date_utc
  ...
  export class LaunchItemDetailsGQL extends Apollo.Query<LaunchItemDetailsQuery, LaunchItemDetailsQueryVariables> {
    document = LaunchItemDetailsDocument;
